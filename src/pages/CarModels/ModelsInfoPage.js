...
const ModelsInfoPage = () => {
  ...
  const fetchCarData = async () => {
    try {
      ...
      const response = await fetch(`https://car-on-rent-backend.onrender.com/api/cars/${id}`, {
        headers: {
  ...
  const handleBooking = async (e) => {
    ...
    console.log(data);
    const response = await fetch("https://car-on-rent-backend.onrender.com/api/bookingdetail", {
